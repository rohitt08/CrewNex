        ...
        <div className="max-w-md w-full glass-card border border-white/50 rounded-3xl p-8 sm:p-10 shadow-2xl relative z-10 animate-fade-in-up">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2 text-base font-medium">
              We've sent a 6-digit code to <br/><span className="font-bold text-slate-800">{formData.email}</span>
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2 text-center">Verification Code</label>
              <input
                type="text"
                maxLength={6}
                value={formData.otp}
          ...
          <div className="text-center mt-8">
            <p className="text-sm font-medium text-slate-500">
              Didn't receive the code? <Link to="/forgot-password" className="text-indigo-600 font-bold hover:underline">Resend OTP</Link>
            </p>
          </div>
        </div>
      </div>
